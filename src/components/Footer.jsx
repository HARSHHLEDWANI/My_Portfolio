...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', href: 'https://github.com/HARSHHLEDWANI', icon: 'github' },
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/harsh-ledwani-097571219', icon: 'linkedin' },
  ];
    ...
    <footer className="bg-light-surface dark:bg-dark-surface border-t border-light-border dark:border-dark-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          >
            © {currentYear} Harsh Ledwani. All rights reserved.
          </motion.p>
