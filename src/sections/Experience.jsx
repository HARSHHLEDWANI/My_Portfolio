...
const Experience = () => {
  ...
  const activities = [
    {
      title: 'Buddy Session - C Programming',
      description: 'Conducted a Buddy Session for first-year students, introducing foundational concepts of C programming.',
      type: 'Teaching',
    },
    {
      title: 'Robotics Workshop',
      description: 'Participated in a Robotics Workshop, gaining experience with embedded systems, automation, and sensor integration.',
      type: 'Workshop',
    },
    {
      title: 'Club Memberships',
      description: 'Former member of the Cyber-Blockchain Club and Rotonity, exploring emerging technologies and community activities.',
      type: 'Community',
    },
  ];
